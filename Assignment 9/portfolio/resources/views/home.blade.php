...
@section('content')
    <div>
        <header class="bg-blue-500 text-white text-center py-8 px-2">
            ...
            <img src="{{ asset('profile.jpeg') }}" alt="My Profile Picture" class="rounded-full mt-4 h-24 w-24 mx-auto">
            <p class="mt-2">👋 Hello there! I'm Shahnewaz, Web Developer.</p>
        </header>

        <!-- About Me Section -->
        <section class="container mx-auto mt-8 px-2">
            <h2 class="text-2xl font-bold mb-4">About Me</h2>
            <p class="text-gray-700">I'm a passionate professional with a love for Exploring new thing. From Dhaka, I've been
                on an exciting journey exploring the realms of [Your Field/Industry].</p>
            <img src="{{ asset('achievements-image.jpg') }}" alt="Your Achievements" class="mt-8 w-full h-52">
        </section>
        ...
        <section class="bg-gray-200 py-8 px-2">
            <div class="container mx-auto px-2">
                ...
                <p class="text-gray-700">In a nutshell, I'm a [Brief Summary of Your Skills]. Whether it's [Specific Skill
                    1], [Specific Skill 2], or [Specific Skill 3], I bring creativity, dedication, and a knack for [Unique
                    Selling Point] to the table.</p>
            </div>
        </section>
        ...
        <section class="bg-blue-500 text-white py-8">
            <div class="container mx-auto text-center">
                ...
                <p class="text-gray-200">Ready to take the next step? Whether you have a project in mind or just want to say
                    hi, I'm always open to new opportunities.</p>
                <p class="mt-4">
